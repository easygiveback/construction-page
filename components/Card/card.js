				...
				<div className={styles.card}>
					<div className={flip}>
						<div className={styles['card__front']}>
							<h1>
								easy
								<span className={styles['card__front__h1divider']}>
									giveback
								</span>
							</h1>
						...
						<div className={styles['card__back']}>
							<p className={styles['card__back__description']}>
								Die Spendenseite easygiveback.de ist eine Plattform, mit der man
								einfach und effektiv an gemeinnützige Organisationen oder
								Vereine spenden kann. In einem studiengangübergreifenden Projekt
								an der Hochschule der Medien in Stuttgart wurde die
								Spendenplattform entwickelt, die es ermöglicht, die passenden
								Wohltätigkeitsorganisationen für sich zu finden und direkt an
								mehrere zu spenden. Die Suche wird durch eine intelligente
								Filterfunktion vereinfacht und man kann sich vor einer Spende
								grundlegend über die Hilfsorganisationen informieren. In
								weiterführenden Semestern sollen auch ehrenamtliche Tätigkeiten,
								Projekte, Sachspenden oder Patenschaften vermittelt werden.
								Gemeinsam machen wir gute Taten zu Tatsachen - einfach easy Geld
								für dein Herzensprojekt spenden.
							</p>
							<Button
								setFlipMe={() => setFlipMe(!flipMe)}
